...
export interface EntertainmentService {
    ...
    getEmpBossName(empRcode : string) : Promise<Employee>; // 8. 연예관계자에 대해 연예관계자의 이름과 직속 상사의 이름을 검색하시오
    getEmpNameSal(empName:string, empSal:number) : Promise<Employee>; // 9. 연예관계자에 대해 이름과 급여를 출력하고, 급여의 내림차순으로 정렬하시오. 단, 동일 급여일 때는 이름의 오름차순으로 정렬하시오.
    ...
    updateEmpSal() : Promise<string>; // 13. 연예관계자 김수현 씨가 대리에서 실장으로 승진하고 급여가 20% 증가되었습니다. 알맞게 변경하시오
    insertEmp() : Promise<string>; // 14. 우리 회사에 한 명의 임원이 등록되었습니다. 코드는 E903, 이름은 손진현, 관리자는 E901, 급여는 4000입니다. 알맞게 등록하시오.
    deleteEmp() : Promise<string>; // 15. 연예관계자인 손진현님이 퇴직했습니다. 연예관계자 목록에서 제거하시오.
